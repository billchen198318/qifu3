...
function addTab( tabId, srcUrl ) {
	...
	// 2020-01-20 add
	$('#myTab').append('<li class="nav-item" id="_tab_' + tabId + '"><a class="nav-link" data-toggle="tab" href="#' + tabId + '" role="tab" aria-controls="' + tabId + '"><i class="icon fa fa-' + fontIconClassId + '"></i>&nbsp;' + progName + '&nbsp;<span class="badge badge-warning btn" onclick="closeTab(\'' + tabId + '\');">X</span></a></li>');
