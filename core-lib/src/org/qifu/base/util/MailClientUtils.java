...
public class MailClientUtils {
	...
	@Autowired
	SpringMailSessionConfigProperties springMailSessionConfigProperties;
	
	/*
	@Autowired
	TemplateUtils templateUtils;
	
	public void sendByTemplate(String from, String to, java.io.Serializable pk, Map<String, Object> subjectProcessParam, Map<String, Object> contentProcessParam) throws ServiceException, Exception {
		TemplateResult templateResult = templateUtils.process(pk, subjectProcessParam, contentProcessParam);
		this.send(from, to, templateResult.getSubject(), templateResult.getContent());
	}
	
	public void sendByTemplate(String from, String to, String templateId, Map<String, Object> subjectProcessParam, Map<String, Object> contentProcessParam) throws ServiceException, Exception {
		TemplateResult templateResult = templateUtils.process(templateId, subjectProcessParam, contentProcessParam);
		this.send(from, to, templateResult.getSubject(), templateResult.getContent());		
	}
	*/
